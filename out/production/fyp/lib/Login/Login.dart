...
import 'package:medichat/Login/components/cancel_button.dart';
import 'package:medichat/Login/components/login_form.dart';
import 'package:medichat/Login/components/register_form.dart';
          ...
          LoginForm(
            ...
            onLoginSuccess: (user) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("Login Successfully"), duration: Duration(seconds: 1)),
              );
